...
const bot = new Client({
  ...
  partials: [Partials.Channel] // вместо строки 'CHANNEL'
});
				...
				// might wanna take this up to the moment when an embed is created:
						...
						fs.open('./logs.txt', 'a+', (err, fd) => {
							try {
								...
								let logData = `[${x.toUTCString()}]: User ${interaction.user.username} have adjusted their .mp3 rates: ${JSON.stringify(pl)}\n`;
